...
It's a basic substitution cipher. One way to break it is by looking to letters frequency. For example we know that in english the e is very frequent, then the t, then a, etc. Then you look to couples of letters, for example et, at, th, etc, and finally you can break the code, or you can use tools which will provide with all the patterns of the ciphertext.

Read about letter frequencies at : [Letter frequency - Wikipedia](https://en.wikipedia.org/wiki/Letter_frequency)

Tool : https://quipqiup.com/

### Deciphered Text
THE FLAG IS IFONLYMODERNCRYPTOWASLIKETHIS. GENERATED BY MARKOV CHAIN OF THE WIKIPEDIA PAGE ON ......
